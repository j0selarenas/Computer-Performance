...
def arreglarArchivo(input_usuario):
    ...
    a = usuario.find("rendimiento_matmul_") + 19
    name = ""  
    while a < len(usuario):
        name += usuario[a]
        a += 1
...
if nameArch == 'llena':
    xlim = 20_000
elif nameArch == 'dispersa':
    addList = [100_000, 500_000, 1_000_000, 5_000_000, 10_000_000, 25_000_000, 50_000_000]
    xlim = 50_000_000
    for i in addList:
        rango_N.append(i)
        rango_N_str.append(str(i))
...
plt.title('Rendimiento Laplaciana MATMUL '+nameArch)
plt.grid()
...
graph_name = "grafico_matmul_" + nameArch + ".png"
